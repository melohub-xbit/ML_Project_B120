...
import joblib
joblib.dump(final_model_full, 'xgboost_model.pkl')
joblib.dump(final_encoder_full, 'xgboost_encoder.pkl')
print("\n[ENSEMBLE] Saved final model: xgboost_model.pkl")
print("[ENSEMBLE] Saved encoder: xgboost_encoder.pkl")
...
np.save('log_preds_xgb.npy', test_predictions_log)
print("[ENSEMBLE] Saved log predictions: log_preds_xgb.npy")
